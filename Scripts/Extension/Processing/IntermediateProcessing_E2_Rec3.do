...
drop if (statefips==48 | statefips==45)
...
gen doesOpen = 0
replace doesOpen = 1 if (statefips==26 | statefips==40 | statefips==47 | statefips==55)
gen afterEvent = 0
...
save Data/Extension/IntermediateData/intermediate_E3_Rec3.dta, replace
