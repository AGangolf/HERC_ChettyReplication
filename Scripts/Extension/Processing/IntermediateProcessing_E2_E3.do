...
*Reopening Date of Interest is 05/02/20*
...
drop if (statefips==13 | statefips==19 | statefips==38 | statefips==48)
...
gen doesOpen = 0
replace doesOpen = 1 if (statefips==40)
gen afterEvent = 0
...
save Data/Extension/IntermediateData/intermediate_E3_E3.dta, replace
