...
*Reopening Date of Interest is 04/24/20*
gen dateOfInterest = mdy(04,27,2020)
...
drop if (statefips==45 | statefips==2 | statefips==13 | statefips==26 | statefips==40)
...
gen doesOpen = 0
replace doesOpen = 1 if (statefips==8 | statefips==30 | statefips==28)
gen afterEvent = 0
...
save Data/Extension/IntermediateData/intermediate_E3_Ret3.dta, replace
