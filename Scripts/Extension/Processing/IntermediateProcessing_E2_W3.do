...
*Reopening Date of Interest is 05/04/20*
gen dateOfInterest = mdy(05,04,2020)
...
drop if (statefips==30 | statefips==16 | statefips==40)
...
gen doesOpen = 0
replace doesOpen = 1 if (statefips==20 | statefips==31)
gen afterEvent = 0
...
save Data/Extension/IntermediateData/intermediate_E3_W3.dta, replace
