...
*Reopening Date of Interest is 04/26/20*
gen dateOfInterest = mdy(04,26,2020)
...
gen doesOpen = 0
replace doesOpen = 1 if statefips==30
gen afterEvent = 0
...
save Data/Extension/IntermediateData/intermediate_E3_W1.dta, replace
