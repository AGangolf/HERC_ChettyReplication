...
use "Data/Mobility/IntermediateData/intermediate1_GM1.dta"

*Converts date into a Stata readable format*
generate date = mdy(month, day, year)
format date %td

*Converts daily data to weekly data
...
drop if !(statefips==18 | statefips==45 | statefips==29 | statefips==31 | statefips==35 | statefips==41 | statefips==46)
...
save Data/Mobility/IntermediateData/intermediate2_GM1.dta, replace
