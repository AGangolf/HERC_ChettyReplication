...
levelsof statefips if inlist(statefips, 2), clean separate(,) local(treatStates)

*Remove control states which reopened the same sector within three weeks of treatment*
drop if (!inlist(statefips, `treatStates') & date>=dateOfInterest & date<=dateOfInterest+21 & food==1)
...
synth spend_all spend_all(`startDate'(1)`dOI'), trunit(`treatState') trperiod(`dOI') keep(~/Projects/HERC_ChettyReplication/Data/Synthetic/IntermediateData/intermediate_SC3_F1_SPEND.dta) replace
synth emp emp(`startDate'(1)`dOI'), trunit(`treatState') trperiod(`dOI') keep(~/Projects/HERC_ChettyReplication/Data/Synthetic/IntermediateData/intermediate_SC3_F1_EMP.dta) replace
synth merchants_all merchants_all(`startDate'(1)`dOI'), trunit(`treatState') trperiod(`dOI') keep(~/Projects/HERC_ChettyReplication/Data/Synthetic/IntermediateData/intermediate_SC3_F1_MOB.dta) replace
synth gps gps(`startDate'(1)`dOI'), trunit(`treatState') trperiod(`dOI') keep(~/Projects/HERC_ChettyReplication/Data/Synthetic/IntermediateData/intermediate_SC3_F1_GPS.dta) replace


*Reshape Synthetic Control Data*
use "Data/Synthetic/IntermediateData/intermediate_SC3_F1_SPEND.dta", clear
drop _Co_Number _W_Weight
ren _Y_treated spend_all1
ren _Y_synthetic spend_all0
reshape long spend_all, i(_time) j(doesOpen)
save Data/Synthetic/IntermediateData/intermediate_SC3_F1_SPEND.dta, replace

use "Data/Synthetic/IntermediateData/intermediate_SC3_F1_EMP.dta", clear
drop _Co_Number _W_Weight
ren _Y_treated emp1
ren _Y_synthetic emp0
reshape long emp, i(_time) j(doesOpen)
save Data/Synthetic/IntermediateData/intermediate_SC3_F1_EMP.dta, replace

use "Data/Synthetic/IntermediateData/intermediate_SC3_F1_MOB.dta", clear
drop _Co_Number _W_Weight
ren _Y_treated merchants_all1
ren _Y_synthetic merchants_all0
reshape long merchants_all, i(_time) j(doesOpen)
save Data/Synthetic/IntermediateData/intermediate_SC3_F1_MOB.dta, replace

use "Data/Synthetic/IntermediateData/intermediate_SC3_F1_GPS.dta", clear
drop _Co_Number _W_Weight
ren _Y_treated gps1
ren _Y_synthetic gps0
reshape long gps, i(_time) j(doesOpen)
save Data/Synthetic/IntermediateData/intermediate_SC3_F1_GPS.dta, replace

*Merge*
use "Data/Synthetic/IntermediateData/intermediate_SC3_F1_SPEND.dta", clear
merge 1:1 _time doesOpen using "Data/Synthetic/IntermediateData/intermediate_SC3_F1_EMP.dta"
drop _merge
merge 1:1 _time doesOpen using "Data/Synthetic/IntermediateData/intermediate_SC3_F1_MOB.dta"
drop _merge
merge 1:1 _time doesOpen using "Data/Synthetic/IntermediateData/intermediate_SC3_F1_GPS.dta"
drop _merge
ren _time date
format date %td
